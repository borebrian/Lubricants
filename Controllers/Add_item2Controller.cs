...
{
    public class Add_item2Controller : Controller
    {
        private readonly ApplicationDBContext _context;

        public Add_item2Controller(ApplicationDBContext context)
        {
            _context = context;
        }
        ...
        // GET: Add_item2/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Add_item2/Create
